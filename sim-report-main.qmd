...
if (all(fda_iqr$iqr > srvf_iqr$iqr)) {
  cat("- CC methods show competitive medians but heavier tails (more variable performance).\n")
}
cat("\n")
```
